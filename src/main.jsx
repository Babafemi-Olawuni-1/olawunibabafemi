...
function App() {
  ...
  return <><CodeRain /><ScrollProgress /><AvailabilityBadge /><WhatsAppFloat /><BackToTop /><Navigation /><main><Hero /><About /><Capabilities /><Projects /><Experience /><Stack /><Statement /><Contact /></main><footer><div><Logo /></div><span>© 2026 Babafemi David Olawuni</span></footer>{paletteOpen && <CommandPalette onClose={() => setPaletteOpen(false)} />}</>
}
